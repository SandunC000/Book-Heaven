const styles = {
  ...
  button: 'rounded-full mt-2 py-2 px-3 bg-dimWhite font-poppins text-primary font-semibold transition duration-300 hover:bg-blue-400',
  buttonCancel: 'rounded-full mt-2 py-2 px-3 bg-dimWhite font-poppins text-primary font-semibold transition duration-300 hover:bg-red-400',
